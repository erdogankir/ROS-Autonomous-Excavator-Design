...
![PCAD Prototype](media/images/17.JPG)
...
**ROS & Simülasyon Tarafı:**
* ROS Noetic Ninjemys (Ubuntu 20.04)
* Gazebo 11 (ODE Fizik Motoru)
* MoveIt! ve KDL Kütüphanesi (`ros-noetic-moveit`)
* OctoMap 3B Haritalama (`ros-noetic-octomap`, `ros-noetic-octomap-rviz-plugins`)
* OpenCV Görüntü İşleme Kütüphanesi (`ros-noetic-vision-opencv`)

**Gömülü Sistem Tarafı:**
* PlatformIO IDE
* ESP32 Board Paketleri
* Adafruit PCA9685 PWM Sürücü Kütüphanesi

## 🚀 Kurulum Talimatları

**1. ROS Çalışma Alanının Derlenmesi:**
```bash
mkdir -p ~/catkin_ws/src
cd ~/catkin_ws/src
git clone [https://github.com/erdogankir/ROS-Autonomous-Excavator-Design.git](https://github.com/erdogankir/ROS-Autonomous-Excavator-Design.git)
...
**2. Gömülü Yazılımın Flaşlanması:**
...
## 📌 Sürüm ve Commit Bilgisi
* **Raporla Eşleşen Sabit Sürüm:** [v1.0.0 - Bitirme Raporu Sürümü](https://github.com/erdogankir/ROS-Autonomous-Excavator-Design/releases/tag/v1.0.0)
